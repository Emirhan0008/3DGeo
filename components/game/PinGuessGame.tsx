...
export default function PinGuessGame() {
  ...
  if (isCollapsed) {
    return (
      <div 
        ...
        className="absolute top-11 sm:top-2 left-1/2 -translate-x-1/2 z-30 w-[95vw] sm:w-auto max-w-lg sm:max-w-[96vw] bg-[#09090b]/95 backdrop-blur-2xl border-2 border-amber-400/80 rounded-xl shadow-2xl px-2.5 py-1.5 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-1.5 text-white animate-in fade-in duration-200 cursor-pointer"
      >
        {/* Row 1 on mobile portrait / Left section on landscape */}
        <div className="flex items-center justify-between gap-2 min-w-0 flex-1">
          <div className="flex items-center gap-1.5 min-w-0 flex-1">
            <span className="px-1.5 py-0.5 rounded bg-amber-400 text-slate-950 font-black text-[9px] sm:text-[10px] shrink-0 flex items-center gap-0.5 shadow-sm">
              <MapPin className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
              ARANAN:
            </span>
            <span className="font-black text-xs sm:text-sm text-amber-300 leading-snug break-words line-clamp-2 sm:line-clamp-1">
              {displayTitle}
            </span>
          </div>
        ...
        <div className="flex items-center justify-between sm:justify-end gap-1 shrink-0 border-t sm:border-t-0 border-white/10 pt-1 sm:pt-0">
          <span className="text-[9px] text-slate-400 font-semibold sm:hidden truncate max-w-[120px]">
            {currentQ.category}
          </span>
          ...
          <div className="flex items-center gap-1 shrink-0 ml-auto sm:ml-0">
            <button
              ...
              className="px-2.5 py-1 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-[10px] sm:text-xs rounded-lg flex items-center gap-0.5 shadow-md transition-all active:scale-95 shrink-0 cursor-pointer"
            >
              <span>Sonraki</span>
            ...
            <button
              ...
              className="px-2 py-1 bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-[10px] sm:text-xs rounded-lg flex items-center gap-0.5 border border-indigo-400 transition-all active:scale-95 shrink-0 cursor-pointer"
            >
  ...
  const containerClasses = "absolute top-11 sm:top-2 left-1/2 -translate-x-1/2 z-30 w-[95vw] sm:w-[85vw] md:w-[520px] lg:w-[560px] max-w-2xl bg-[#09090b]/95 backdrop-blur-2xl border border-indigo-500/40 rounded-xl shadow-2xl overflow-hidden text-slate-100 p-1.5 transition-all";
