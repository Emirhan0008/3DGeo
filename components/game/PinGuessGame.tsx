...
export default function PinGuessGame() {
  ...
  if (isCollapsed) {
    return (
      <div className="absolute top-11 sm:top-12 left-1/2 -translate-x-1/2 z-30 w-[92vw] max-w-xs sm:max-w-md bg-[#09090b]/95 backdrop-blur-2xl border-2 border-amber-400/80 rounded-xl shadow-2xl px-2.5 py-1 flex items-center justify-between gap-2 text-white animate-in fade-in duration-200">
  ...
  return (
    <DraggableCard
      className="absolute top-11 sm:top-12 left-1/2 -translate-x-1/2 z-30 w-[95vw] max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl bg-[#09090b]/95 backdrop-blur-2xl border-2 border-indigo-500/40 rounded-xl shadow-2xl overflow-hidden text-slate-100 p-2 sm:p-2.5 transition-all"
    >
      {/* Top Controls Bar */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-2 items-center">
        {/* Column 1: Target Badge & Photo */}
        <div className="md:col-span-5 space-y-1.5">
          <div className="p-1.5 bg-gradient-to-r from-amber-500/25 via-indigo-600/25 to-purple-600/25 border border-amber-400/80 rounded-lg flex items-center justify-between gap-1.5">
            <div className="flex items-center gap-1.5 overflow-hidden">
              <span className="p-1 bg-amber-400 text-slate-950 rounded font-black text-[10px] shrink-0 flex items-center gap-0.5">
                <MapPin className="w-3 h-3" />
                ARANAN:
              </span>
            ...
            {currentQ.region && (
              <span className="text-[9px] uppercase font-black px-1.5 py-0.5 rounded bg-amber-400/20 text-amber-300 border border-amber-400/30 shrink-0">
                {currentQ.region}
              </span>
            )}
          </div>
