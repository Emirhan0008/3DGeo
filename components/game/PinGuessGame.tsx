...
export default function PinGuessGame() {
  ...
  if (isCollapsed) {
    return (
      <div className="absolute top-2 left-1/2 -translate-x-1/2 z-30 w-auto max-w-[92vw] bg-[#09090b]/95 backdrop-blur-2xl border-2 border-amber-400/80 rounded-xl shadow-2xl px-2.5 py-1.5 flex items-center justify-between gap-2 text-white animate-in fade-in duration-200">
